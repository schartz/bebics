 ...
 *
 *
 * $Id: EbicsXmlFactory.java 8 2019-05-21 19:11:25Z schartz $
 */
...
import com.github.schartz.bebics.schema.h003.*;
...
import com.github.schartz.bebics.schema.h003.TransactionPhaseType.Enum;
import com.github.schartz.bebics.schema.s001.OrderSignatureDataType;
...
import com.github.schartz.bebics.schema.s001.SignaturePubKeyOrderDataDocument;
import com.github.schartz.bebics.schema.s001.SignaturePubKeyOrderDataType;
import com.github.schartz.bebics.schema.s001.UserSignatureDataDocument;
import com.github.schartz.bebics.schema.s001.UserSignatureDataSigBookType;
...
import com.github.schartz.bebics.schema.xmldsig.SignatureValueType;
import com.github.schartz.bebics.schema.xmldsig.SignedInfoDocument;
...
public class EbicsXmlFactory {
  ...
  public static AuthenticationPubKeyInfoType createAuthenticationPubKeyInfoType(String authenticationVersion,
                                                                                com.github.schartz.bebics.schema.h003.PubKeyValueType pubKeyValue,
   ...
   * @return the <code>PubKeyValueType</code> XML object
   */
  public static com.github.schartz.bebics.schema.h003.PubKeyValueType createH003PubKeyValueType(RSAKeyValueType rsaKeyValue, Calendar timeStamp) {
    com.github.schartz.bebics.schema.h003.PubKeyValueType newPubKeyValueType = com.github.schartz.bebics.schema.h003.PubKeyValueType.Factory.newInstance();
    newPubKeyValueType.setRSAKeyValue(rsaKeyValue);
    newPubKeyValueType.setTimeStamp(timeStamp);
                                                                                ...
                                                                                FULOrderParamsType orderParams)
  {
    ...
    newStaticHeaderOrderDetailsType.setOrderAttribute(OrderAttributeType.Enum.forString(orderAttribute));
   ...
   * @return the <code>EbicsRequestDocument.EbicsRequest.Body</code> XML object
   */
  public static EbicsRequestDocument.EbicsRequest.Body createEbicsRequestBody(TransferReceipt transferReceipt) {
    EbicsRequestDocument.EbicsRequest.Body newBody = EbicsRequestDocument.EbicsRequest.Body.Factory.newInstance();
