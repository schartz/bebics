...
import com.github.schartz.bebics.io.Splitter;
import com.github.schartz.bebics.schema.h003.DataTransferRequestType;
import com.github.schartz.bebics.schema.h003.FULOrderParamsType;
...
public class UInitializationRequestElement extends InitializationRequestElement {
  ...
  public UInitializationRequestElement(EbicsSession session,
                                       com.github.schartz.bebics.session.OrderType orderType,
                                       byte[] userData)
    throws EbicsException
  {
