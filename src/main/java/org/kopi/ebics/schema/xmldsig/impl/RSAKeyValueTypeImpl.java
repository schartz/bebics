 ...
 */
public class RSAKeyValueTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.xmldsig.RSAKeyValueType
{
     ...
     */
    public org.kopi.ebics.schema.xmldsig.CryptoBinary xgetModulus()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.xmldsig.CryptoBinary target = null;
            target = (org.kopi.ebics.schema.xmldsig.CryptoBinary)get_store().find_element_user(MODULUS$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetModulus(org.kopi.ebics.schema.xmldsig.CryptoBinary modulus)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.xmldsig.CryptoBinary)get_store().add_element_user(MODULUS$0);
            }
            target.set(modulus);
        }
    }
     ...
     */
    public org.kopi.ebics.schema.xmldsig.CryptoBinary xgetExponent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.xmldsig.CryptoBinary target = null;
            target = (org.kopi.ebics.schema.xmldsig.CryptoBinary)get_store().find_element_user(EXPONENT$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetExponent(org.kopi.ebics.schema.xmldsig.CryptoBinary exponent)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.xmldsig.CryptoBinary)get_store().add_element_user(EXPONENT$2);
            }
            target.set(exponent);
        }
    }
