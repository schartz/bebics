...
import org.kopi.ebics.old.xmldsig.*;
...
public class KeyInfoTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements KeyInfoType
{
     ...
     */
    public void setKeyNameArray(int i, String keyName)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void insertKeyName(int i, String keyName)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setMgmtDataArray(String[] mgmtDataArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setMgmtDataArray(int i, String mgmtData)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void insertMgmtData(int i, String mgmtData)
    {
        synchronized (monitor())
        {
            check_orphaned();
