...
import org.kopi.ebics.old.xmldsig.X509IssuerSerialType;
...
public class X509DataTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements X509DataType
{
     ...
     */
    public void setX509SubjectNameArray(String[] x509SubjectNameArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setX509SubjectNameArray(int i, String x509SubjectName)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void insertX509SubjectName(int i, String x509SubjectName)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void addX509SubjectName(String x509SubjectName)
    {
        synchronized (monitor())
        {
            check_orphaned();
