...
public class DataTransferRequestTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements DataTransferRequestType
{
    ...
    public SignatureData getSignatureData()
    {
        synchronized (monitor())
        {
            ...
            target = (SignatureData)get_store().find_element_user(SIGNATUREDATA$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public SignatureData addNewSignatureData()
    {
        synchronized (monitor())
        {
            check_orphaned();
            SignatureData target = null;
            target = (SignatureData)get_store().add_element_user(SIGNATUREDATA$2);
            return target;
        }
    }
    ...
    public OrderData getOrderData()
    {
        synchronized (monitor())
        {
            ...
            target = (OrderData)get_store().find_element_user(ORDERDATA$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public OrderData addNewOrderData()
    {
        synchronized (monitor())
        {
            check_orphaned();
            OrderData target = null;
            target = (OrderData)get_store().add_element_user(ORDERDATA$4);
            return target;
        }
    }
