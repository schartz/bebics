...
public interface UserInfoType extends org.apache.xmlbeans.XmlObject
{
    ...
    public static final class Factory
    {
        ...
        public static UserInfoType parse(String xmlAsString) throws org.apache.xmlbeans.XmlException {
          return (UserInfoType) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( xmlAsString, type, null ); }
        
        public static UserInfoType parse(String xmlAsString, org.apache.xmlbeans.XmlOptions options) throws org.apache.xmlbeans.XmlException {
