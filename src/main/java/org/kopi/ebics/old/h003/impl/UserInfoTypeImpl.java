...
import org.kopi.ebics.old.h003.NameType;
import org.kopi.ebics.old.h003.UserInfoType;
import org.kopi.ebics.old.h003.UserPermissionType;
import org.kopi.ebics.old.h003.UserStatusType;
...
public class UserInfoTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements UserInfoType
{
    ...
    public UserID getUserID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            UserID target = null;
            target = (UserID)get_store().find_element_user(USERID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public UserID addNewUserID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            UserID target = null;
            target = (UserID)get_store().add_element_user(USERID$0);
            return target;
        }
    }
     ...
     */
    public static class UserIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements UserID
    {
        private static final long serialVersionUID = 1L;
