...
public class PartnerInfoTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements PartnerInfoType
{
     ...
     */
    public AccountInfo[] getAccountInfoArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            AccountInfo[] result = new AccountInfo[targetList.size()];
     ...
     */
    public AccountInfo getAccountInfoArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            AccountInfo target = null;
            target = (AccountInfo)get_store().find_element_user(ACCOUNTINFO$4, i);
            if (target == null)
            {
     ...
     */
    public void setAccountInfoArray(AccountInfo[] accountInfoArray)
    {
        check_orphaned();
     ...
     */
    public void setAccountInfoArray(int i, AccountInfo accountInfo)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public AccountInfo insertNewAccountInfo(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            AccountInfo target = null;
            target = (AccountInfo)get_store().insert_element_user(ACCOUNTINFO$4, i);
            return target;
        }
    }
    ...
    public AccountInfo addNewAccountInfo()
    {
        synchronized (monitor())
        {
            check_orphaned();
            AccountInfo target = null;
            target = (AccountInfo)get_store().add_element_user(ACCOUNTINFO$4);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class AccountInfoImpl extends AccountTypeImpl implements AccountInfo
    {
        private static final long serialVersionUID = 1L;
