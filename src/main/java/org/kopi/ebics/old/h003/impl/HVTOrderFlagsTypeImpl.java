...
import org.kopi.ebics.old.h003.HVTOrderFlagsType;
...
public class HVTOrderFlagsTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements HVTOrderFlagsType
{
     ...
     */
    public FetchLimit xgetFetchLimit()
    {
        synchronized (monitor())
        {
            check_orphaned();
            FetchLimit target = null;
            target = (FetchLimit)get_store().find_attribute_user(FETCHLIMIT$2);
            if (target == null)
            {
                target = (FetchLimit)get_default_attribute_value(FETCHLIMIT$2);
            }
            return target;
        }
    }
     ...
     */
    public void xsetFetchLimit(FetchLimit fetchLimit)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (FetchLimit)get_store().add_attribute_user(FETCHLIMIT$2);
            }
     ...
     */
    public FetchOffset xgetFetchOffset()
    {
        synchronized (monitor())
        {
            check_orphaned();
            FetchOffset target = null;
            target = (FetchOffset)get_store().find_attribute_user(FETCHOFFSET$4);
            if (target == null)
            {
                target = (FetchOffset)get_default_attribute_value(FETCHOFFSET$4);
            }
            return target;
        }
    }
     ...
     */
    public void xsetFetchOffset(FetchOffset fetchOffset)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (FetchOffset)get_store().add_attribute_user(FETCHOFFSET$4);
            }
     ...
     */
    public static class FetchLimitImpl extends org.apache.xmlbeans.impl.values.JavaLongHolderEx implements FetchLimit
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class FetchOffsetImpl extends org.apache.xmlbeans.impl.values.JavaLongHolderEx implements FetchOffset
    {
        private static final long serialVersionUID = 1L;
