...
import org.kopi.ebics.old.h003.ResponseMutableHeaderType;
import org.kopi.ebics.old.h003.ReturnCodeType;
import org.kopi.ebics.old.h003.TransactionPhaseType;
...
public class ResponseMutableHeaderTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements ResponseMutableHeaderType
{
    ...
    public SegmentNumber getSegmentNumber()
    {
        ...
        {
            check_orphaned();
            SegmentNumber target = null;
            target = (SegmentNumber)get_store().find_element_user(SEGMENTNUMBER$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public SegmentNumber addNewSegmentNumber()
    {
        synchronized (monitor())
        {
            check_orphaned();
            SegmentNumber target = null;
            target = (SegmentNumber)get_store().add_element_user(SEGMENTNUMBER$2);
            return target;
        }
    }
     ...
     */
    public static class SegmentNumberImpl extends org.apache.xmlbeans.impl.values.JavaLongHolderEx implements SegmentNumber
    {
        private static final long serialVersionUID = 1L;
