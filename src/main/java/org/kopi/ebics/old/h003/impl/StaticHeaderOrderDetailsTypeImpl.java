...
import org.kopi.ebics.old.h003.OrderAttributeType;
...
public class StaticHeaderOrderDetailsTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements StaticHeaderOrderDetailsType
{
    ...
    public OrderType getOrderType()
    {
        synchronized (monitor())
        {
            ...
            target = (OrderType)get_store().find_element_user(ORDERTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public OrderType addNewOrderType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            OrderType target = null;
            target = (OrderType)get_store().add_element_user(ORDERTYPE$0);
            return target;
        }
    }
     ...
     */
    public static class OrderTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements OrderType
    {
        private static final long serialVersionUID = 1L;
