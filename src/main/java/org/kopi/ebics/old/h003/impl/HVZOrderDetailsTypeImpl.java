...
public class HVZOrderDetailsTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements HVZOrderDetailsType
{
     ...
     */
    public TotalAmount xgetTotalAmount()
    {
        synchronized (monitor())
        {
            check_orphaned();
            TotalAmount target = null;
            target = (TotalAmount)get_store().find_element_user(TOTALAMOUNT$14, 0);
            return target;
        }
    }
     ...
     */
    public void xsetTotalAmount(TotalAmount totalAmount)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (TotalAmount)get_store().add_element_user(TOTALAMOUNT$14);
            }
    ...
    public FirstOrderInfo getFirstOrderInfo()
    {
        ...
        {
            check_orphaned();
            FirstOrderInfo target = null;
            target = (FirstOrderInfo)get_store().find_element_user(FIRSTORDERINFO$18, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public FirstOrderInfo addNewFirstOrderInfo()
    {
        synchronized (monitor())
        {
            check_orphaned();
            FirstOrderInfo target = null;
            target = (FirstOrderInfo)get_store().add_element_user(FIRSTORDERINFO$18);
            return target;
        }
    }
     ...
     */
    public static class TotalAmountImpl extends org.apache.xmlbeans.impl.values.JavaDecimalHolderEx implements TotalAmount
    {
        private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class FirstOrderInfoImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements FirstOrderInfo
    {
        private static final long serialVersionUID = 1L;
        ...
        public AccountInfo getAccountInfo()
        {
            synchronized (monitor())
            {
                ...
                target = (AccountInfo)get_store().find_element_user(ACCOUNTINFO$2, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public AccountInfo addNewAccountInfo()
        {
            synchronized (monitor())
            {
                check_orphaned();
                AccountInfo target = null;
                target = (AccountInfo)get_store().add_element_user(ACCOUNTINFO$2);
                return target;
            }
        }
         ...
         * This is a complex type.
         */
        public static class AccountInfoImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements AccountInfo
        {
            private static final long serialVersionUID = 1L;
