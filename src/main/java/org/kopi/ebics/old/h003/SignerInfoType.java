...
public interface SignerInfoType extends org.apache.xmlbeans.XmlObject
{
    ...
    public static final class Factory
    {
        ...
        public static SignerInfoType parse(String xmlAsString) throws org.apache.xmlbeans.XmlException {
          return (SignerInfoType) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( xmlAsString, type, null ); }
        
        public static SignerInfoType parse(String xmlAsString, org.apache.xmlbeans.XmlOptions options) throws org.apache.xmlbeans.XmlException {
