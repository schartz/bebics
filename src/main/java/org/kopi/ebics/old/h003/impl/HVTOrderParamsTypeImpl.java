...
public class HVTOrderParamsTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements HVTOrderParamsType
{
    ...
    public OrderFlags getOrderFlags()
    {
        ...
        {
            check_orphaned();
            OrderFlags target = null;
            target = (OrderFlags)get_store().find_element_user(ORDERFLAGS$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public OrderFlags addNewOrderFlags()
    {
        synchronized (monitor())
        {
            check_orphaned();
            OrderFlags target = null;
            target = (OrderFlags)get_store().add_element_user(ORDERFLAGS$6);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class OrderFlagsImpl extends HVTOrderFlagsTypeImpl implements OrderFlags
    {
        private static final long serialVersionUID = 1L;
