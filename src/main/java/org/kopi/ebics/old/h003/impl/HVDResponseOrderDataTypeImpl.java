...
import org.kopi.ebics.old.h003.SignerInfoType;
...
public class HVDResponseOrderDataTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements HVDResponseOrderDataType
{
    ...
    {
        generatedSetterHelperImpl(dataDigest, DATADIGEST$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
